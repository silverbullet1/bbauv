...
#     rospy.loginfo("Mission connected to MovebaseServer")
    ...
    with sm_mission:
        ...
        #Lane 2 Start Pos                       
        smach.StateMachine.add('NAV_TO_GATE', NavMoveBase(3,60,-9,-8.7,0.5,235), transitions={'succeeded':'LANE_GATE_TASK', 'failed':'SURFACE'})
...
#         smach.StateMachine.add('NAV_TO_GATE', NavMoveBase(0.5,0.5,-9,-8.7,0.5,235), transitions={'succeeded':'LANE_GATE_TASK', 'failed':'SURFACE'})
        ...
        with lane_gate:
            ...
            smach.StateMachine.add('LANE_SEARCH2', LinearSearch('lane', 20, -1, 'fwd', False, 1), transitions={'succeeded':'LANE_STORE', 'failed':'LANE_SEARCH3'})
...
#            smach.StateMachine.add('LANE_ABOUTURN', GoToHeading(10, 180, True), transitions={'succeeded':'lane_complete'})      
        ...
        with park:
            ...
            smach.StateMachine.add('PARK_SEARCH2', LinearSearch('park', 60, 3, 'sway'), transitions={'succeeded':'PARK_STORE', 'failed':'park_failed'})
        ...
        with lane_park:
            ...
            smach.StateMachine.add('LANE_SEARCH', LinearSearch('lane', 40, 1, 'sway', True, 2), transitions={'succeeded':'LANE_STORE', 'failed':'LANE_SEARCH2'})
            smach.StateMachine.add('LANE_SEARCH2', LinearSearch('lane', 40, -2, 'sway', True, 2), transitions={'succeeded':'LANE_STORE', 'failed':'lane_failed'})            
...
#            smach.StateMachine.add('SPEED_SWAY', GoToDistance(90, -4, 'sway'), transitions={'succeeded':'speed_complete'})
            smach.StateMachine.add('SPEED_SEARCH', LinearSearch('speedtrap', 30, -3, 'sway'), transitions={'succeeded':'SPEED_STORE', 'failed':'SPEED_SEARCH2'})
            smach.StateMachine.add('SPEED_SEARCH2', LinearSearch('speedtrap', 30, -0.5, 'fwd'), transitions={'succeeded':'SPEED_STORE', 'failed':'SPEED_SEARCH3'})
            smach.StateMachine.add('SPEED_SEARCH3', LinearSearch('speedtrap', 30, 3, 'sway'), transitions={'succeeded':'SPEED_STORE', 'failed':'SPEED_SEARCH4'})
            smach.StateMachine.add('SPEED_SEARCH4', LinearSearch('speedtrap', 30, 1, 'fwd'), transitions={'succeeded':'SPEED_STORE', 'failed':'SPEED_SEARCH5'})
            smach.StateMachine.add('SPEED_SEARCH5', LinearSearch('speedtrap', 30, -3, 'sway'), transitions={'succeeded':'SPEED_STORE', 'failed':'speed_failed'})
#            smach.StateMachine.add('SPEED_TO_LANE3', NavMoveBase(1,60,place='lane3'), transitions={'succeeded':'SPEED_FWDSEARCH', 'failed':'speed_failed'})
        ...
        smach.StateMachine.add('HOME', NavMoveBase(1,60,0,0,0.5,60), transitions={'succeeded':'SURFACE', 'failed':'mission_failed'})
