...
### Insert Mission Here ###
    ...
    with sm_mission:
        smach.StateMachine.add('COUNTDOWN', Countdown(15), transitions={'succeeded':'START'})
...
#         smach.StateMachine.add('GO_TO_GATE', GoToDistance(30, 6, 'fwd'), transitions={'succeeded':'SURFACE_VICTORIOUSLY'})
        smach.StateMachine.add('WYPT1', Nav(30,30,30, 2.4,1.3, 0.5,0.5,90), transitions={'succeeded':'WYPT2', 'failed':'SURFACE_SADLY'})
        smach.StateMachine.add('WYPT2', Nav(30,30,30, 4,2.8, 0.5,0.5,90), transitions={'succeeded':'WYPT3', 'failed':'SURFACE_SADLY'})
        smach.StateMachine.add('WYPT3', Nav(30,30,30, 1.9,3.1, 0.5,0.5,90), transitions={'succeeded':'WYPT4', 'failed':'SURFACE_SADLY'})
        ...
        smach.StateMachine.add('SURFACE_VICTORIOUSLY', GoToDepth(5, 0.26), transitions={'succeeded':'mission_complete'})
