...
### Insert Mission Here ###
    ...
    with sm_mission:
        ...
        StateMachine.add('START',Start(5,0.6,20),transitions={'succeeded':'WYPT1'})    
#        StateMachine.add('TURN_TO_GATE', GoToHeading(10, 70), transitions={'succeeded':'GO_TO_GATE'})
#        StateMachine.add('GO_TO_GATE', GoToDistance(30, 6, 'fwd'), transitions={'succeeded':'SURFACE_VICTORIOUSLY'})
        StateMachine.add('WYPT1', Nav(30,60,30, 1,1, 0.6,0.6,20), transitions={'succeeded':'SURFACE_HAPPY', 'failed':'SURFACE_SAD'})
