...
if __name__ == '__main__':
    ...
    with sm_mission:
        ...
        StateMachine.add('GO_TO_GATE', GoToDistance(1, 13, 'fwd'), transitions={'succeeded':'PARK'})
...
###################################################################
        ...
        with drive:
            StateMachine.add('HOVER', HoverSearch('acoustic', 3), transitions={'succeeded':'PINGER', 'failed':'GOFWD'})
