...
if __name__ == '__main__':
    ...
    with sm_mission:
        ...
        smach.StateMachine.add('START',Start(5,0.26,0),transitions={'succeeded':'WYPT1'})    
...
#         smach.StateMachine.add('GO_TO_GATE', GoToDistance(30, 6, 'fwd'), transitions={'succeeded':'SURFACE_VICTORIOUSLY'})
        smach.StateMachine.add('WYPT1', NavMoveBase(30,30,30, 1,3, 0.26,0.26,90), transitions={'succeeded':'WYPT2', 'failed':'SURFACE_SADLY'})
        smach.StateMachine.add('WYPT2', NavMoveBase(30,30,30, 2,4, 0.26,0.26,90), transitions={'succeeded':'WYPT3', 'failed':'SURFACE_SADLY'})
        smach.StateMachine.add('WYPT3', NavMoveBase(30,30,30, 1,3, 0.26,0.26,90), transitions={'succeeded':'SURFACE_VICTORIOUSLY', 'failed':'SURFACE_SADLY'})        
