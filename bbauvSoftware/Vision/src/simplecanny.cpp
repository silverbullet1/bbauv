...
#include <cxcore.h>
#include <highgui.h>
#include <beginner_tutorials/cir.h>
...
public:
 simplecanny()
    : it_(nh_)
  {
     ...
     image_sub_ = it_.subscribe("/camera/rgb/image_color", 1, &simplecanny::imageCb, this);
     image_pub_= it_.advertise("/arcv/Image",1);
 	fix_pub=n.advertise<beginner_tutorials::cir>("topic",1);
