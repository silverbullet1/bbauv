...
class Navigation(object):
    ...
    def collectOdom(self, d):
        self.cpos['x'] = d.pose.pose.position.x
        self.cpos['y'] = d.pose.pose.position.y
    ...
    def navCallback(self, req):
        ...
        rospy.loginfo("Second iteration: (heading: %s, mag: %s)", str(heading),
                      str(distance))
        ...
        rospy.loginfo("Errx: %s, erry: %s", str(errx), str(erry))
        ...
        rospy.loginfo("Computed cardinals: (%s, %s)", str(errx), str(erry))
        ...
        rospy.loginfo("Final iteration: heading: %s", str(
                req.final_heading
            ))
