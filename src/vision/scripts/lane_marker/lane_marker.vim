...
silent only
cd ~/Development/Bumblebee/bbauv/src/vision/scripts/lane_marker
...
badd +0 states.py
badd +0 vision.py
badd +0 ../bot_common/bot_comms.py
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 100 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
normal! 0
tabedit ../bot_common/bot_comms.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
