...
=======
rosbag record --split --duration=600 -b 0 -o $NAME /bot_camera/camera/camera_info /bot_camera/camera/image_raw/compressed /front_camera/camera/camera_info /front_camera/camera/image_rect_color/compressed /depth /altitude /euler /AHRS8_data_e /AHRS8_data_q /LocomotionServer/feedback /controller_points /thruster_speed /odom /task_visualization /WH_DVL_data /map /pressure_data /hull_status /manipulators /rosout
>>>>>>> e780fc17263d50acfdcc3843c801b29a3b408f3f
